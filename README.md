...
RPSCamera logic is the file you need to run

Check line 9 (for macbook cvCap = 1, for windows cvCap=0) per your machine

RPSLogic gets called to define inputs from camera, 

Model used is in rps_yolo11/weights/best.pt
